...
- Added strict no-shared-database write rule in `docs/data/auth-service-storage-contract.md`.
...
## See also
- `docs/specs/auth-service-spec.md` � auth service canonical spec
- `docs/specs/auth-service-test-plan.md` � auth service test plan

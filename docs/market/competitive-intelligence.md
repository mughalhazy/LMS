...
**Gap:** MO-020
**Source authority:** `workspace/foundation/market-research.md` §5 (competition), §6 (market gaps), Deep Market Research §3 (competitor landscape)
...
- `workspace/foundation/market-research.md` §5 (competition), §6 (market gaps), §4 (user sentiment)
- `docs/market/gtm-entry-strategy.md` — positioning and entry strategy
- `docs/specs/platform-behavioral-contract.md` — behavioral contracts that underpin our differentiation
- `docs/specs/adapter-inventory.md` — payment adapter implementation status

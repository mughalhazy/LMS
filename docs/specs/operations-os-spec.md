...
- Master Spec §5.10
- `docs/designs/academy-operations-domain.md`
- `docs/specs/workflow-engine-spec.md`
- `docs/specs/notification-service-spec.md`

---

## Behavioral Contracts (BOS Overlay — 2026-04-04)

*The following sections add behavioral requirements per `platform-behavioral-contract.md` and `workspace/foundation/behavioral-spec.md`. They constrain HOW the capabilities above must behave, not WHAT they contain.*
...
- Zero-dashboard mode is achieved by the combination of: Daily Action List delivery (BC-OPS-03) + actionable messages (BOS§6.1, see `interaction-layer-spec.md`) + guided flows.

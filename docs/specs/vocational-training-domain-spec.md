...
**Implementation notes:**
- Extends `learning-path-spec.md` with a `vocational_pathway_type` flag
- Physical attendance stages: `delivery_mode = "in_person_required"`, instructor sign-off required before unlock
- Integrates with prerequisite engine (`prerequisite-engine-spec.md`)
...
**Implementation notes:**
- Extends `assessment-service-spec.md` with `assessment_type = "practical"`
...
- `learning-path-spec.md` — extends it
- `assessment-service-spec.md` — extends it
- `prerequisite-engine-spec.md` — extends it
- `capability-domain-map.md` — domain must be registered here when built

---

## References

- `workspace/foundation/market-research.md` §3.3 (Vocational segment pain points)
- `docs/designs/domain-capability-extension-model.md` — extension model
- `docs/specs/capability-domain-map.md` — capability domain map
- `SPEC_14` — certificate service
- `docs/specs/features/learning-path-spec.md`
- `docs/specs/assessment-service-spec.md`

...
> **Deprecation notice:** This spec has been superseded by `docs/specs/rbac-service-spec.md`. Refer to SPEC_03 for the canonical RBAC service definition.

## See also
- `docs/specs/rbac-service-spec.md` � canonical RBAC service spec

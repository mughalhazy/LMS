...
Operations, data model, and business rules for the learning path service.
...
## See also
- `backend/services/learning-path-service/README.md` � learning path service implementation
- `docs/specs/features/prerequisite-engine-spec.md` � prerequisite engine spec

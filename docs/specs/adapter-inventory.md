...
|---|---|---|---|---|
| Payment | IMPLEMENTED | `integrations/payments/` (canonical) | `docs/contracts/payment-provider-adapter-contract.md` | `easypaisa_adapter.py`, `jazzcash_adapter.py`, `raast_adapter.py`, `stripe_adapter.py`, `paypal_adapter.py` |
| Communication | IMPLEMENTED | `integrations/communication/` | `docs/contracts/communication-adapter-contract.md` | `email_adapter.py`, `sms_adapter.py`, `whatsapp_adapter.py` |
| Storage | IMPLEMENTED | `integrations/storage/` | `docs/contracts/storage-adapter-interface-contract.md` | `s3_adapter.py` (S3/S3-compatible), `local_adapter.py` (local/dev) |
| Third-party integrations | PARTIAL | `services/integration-service/` | `docs/api/integration-api.md` | HRIS sync, LTI, webhooks |
...
**Interface contract:** `docs/contracts/payment-provider-adapter-contract.md`
**QC validation:** `docs/qc/payment-adapter-validation-report.md` — PASS 10/10
...
**Interface contract:** `docs/contracts/communication-adapter-contract.md`
**QC validation:** `docs/qc/communication-workflow-validation-report.md` — PASS 10/10
...
**Interface contract:** `docs/contracts/storage-adapter-interface-contract.md`
...
**Canonical buckets (per file-storage-design.md):**
...
**Spec:** `docs/specs/integration-service-spec.md`
**Integration API:** `docs/api/integration-api.md`

| Integration | Status | Spec ref |
|---|---|---|
| HRIS sync | IMPLEMENTED | `docs/integrations/hris-sync-spec.md` |
| LTI consumer | IMPLEMENTED | `docs/integrations/lti-consumer-spec.md` |
| LTI provider | IMPLEMENTED | `docs/integrations/lti-provider-spec.md` |
| Webhooks | IMPLEMENTED | `docs/integrations/webhook-system-spec.md` |
| SCORM runtime | IMPLEMENTED | `docs/specs/features/scorm-runtime-spec.md` |
| xAPI | IMPLEMENTED | `docs/integrations/standards-support.md` |
...
|---|---|---|
| Payment | `integrations/payments/` | `docs/contracts/payment-provider-adapter-contract.md` |
| Communication | `integrations/communication/` | `docs/contracts/communication-adapter-contract.md` |
| Storage | `integrations/storage/` | `docs/contracts/storage-adapter-interface-contract.md` |

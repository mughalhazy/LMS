...
- `docs/designs/tenant-extension-model.md`
- `docs/designs/config-service-design.md`
...
**Specification:**
The current spec covers CAP-AUTOMATED-CONFIGURATION for the capability bundle (step 3–4 in the onboarding sequence). This contract extends the smart defaults requirement to the FULL customisation surface defined in `docs/architecture/tenant-customization-catalogue.md`:

# DOC_01 — Capability Domain Inventory (Global Capability Platform)

> **TERMINOLOGY NOTE (2026-04-04, updated 2026-04-11 — DF-02):** "Feature" in this document = "Capability" in Master Spec language. "Feature inventory" = "Capability domain inventory". Originally authored as "Enterprise LMS V2 Feature Inventory" — "Enterprise LMS V2" refers to the heritage Rails runtime layer; the platform identity is **Global Capability Platform** per Master Spec §0.1. See `docs/architecture/DOC_NORM_01_terminology_bridge.md` for the full terminology map.

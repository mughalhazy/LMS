...
The capability registry service is the single source of truth for all capability metadata and dependency relationships. Full design in `docs/designs/capability-registry-service-design.md`. This spec documents the deployable service.
...
- Master Spec §2
- `docs/designs/capability-registry-service-design.md` (full design — canonical)
- `docs/anchors/capability-resolution.md`
- `docs/qc/capability-registry-validation-report.md` — PASS 10/10

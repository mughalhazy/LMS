...
- `docs/designs/market-enforcements-capability-map.md` (items 2, 3)

---

## Behavioral Contracts (BOS Overlay — 2026-04-04)

*The following sections add behavioral requirements per `platform-behavioral-contract.md`. These contracts govern the interaction layer once built, and also define the behavioral target for the build.*

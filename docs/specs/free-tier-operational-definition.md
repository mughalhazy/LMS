...
**Source authority:** `workspace/foundation/market-research.md` §9 (pricing), `workspace/foundation/behavioral-spec.md` §7.5
**Status:** SPEC COMPLETE — implementation in `billing-and-usage-model.md` and `entitlement-service`
...
- `docs/specs/platform-behavioral-contract.md` — BC-FREE-01
- `docs/specs/billing-and-usage-model.md` — billing model and tier definitions
- `services/entitlement-service/` — quota enforcement
- `services/commerce/` — plan management
- `services/onboarding/` — first-session flow
- `workspace/foundation/market-research.md` §9 (pricing expectations), §7 (customer behavior)

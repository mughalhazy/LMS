...
- **Already documented in:** `docs/designs/revenue-service-design.md`
...
- Master Spec §5.15
- `docs/designs/revenue-service-design.md` (revenue analytics)
- `docs/specs/billing-and-usage-model.md` (metering definitions)
- `docs/designs/usage-metering-service-design.md`
...
**Specification:**
- CAP-PROFITABILITY-INSIGHTS, CAP-COST-TRACKING, and CAP-REVENUE-ANALYTICS outputs for operator-facing views must follow the insight envelope format (see BC-ANALYTICS-01 in `analytics-service-spec.md`).

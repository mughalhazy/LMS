...
Core CRUD endpoints for the primary LMS entities. See `docs/api/api-gateway-design.md` for gateway configuration and `docs/api/api-spec-validation-report.md` for known gaps.
...
- `docs/specs/auth-service-spec.md` � auth service spec

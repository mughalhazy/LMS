...
**Contract name:** MS-CONFIG-01 (authoritative definition in `docs/architecture/B2P01_config_service_design.md`)
...
See `docs/architecture/B2P01_config_service_design.md` MS-CONFIG-01 for the full rule, prohibited pattern, and enforcement requirement.

...
| Cohort | `docs/specs/cohort-service-spec.md` | Existing concept retained directly. |
...
| Progress | `docs/specs/features/progress-tracking-spec.md` | Tracks lesson/course progression keyed by enrollment. |

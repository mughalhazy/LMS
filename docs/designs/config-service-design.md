...
**Scope:** This contract applies to this service AND to every service that consumes its output. It is stated here as the authoritative definition; `docs/anchors/capability-resolution.md` carries a cross-reference.

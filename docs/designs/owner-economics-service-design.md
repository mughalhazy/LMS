...
- Master Spec §5.14
- `docs/specs/economic-capabilities-user-spec.md`
- `docs/designs/revenue-service-design.md` (system revenue — complement)
...
- `docs/designs/commerce-domain-architecture.md` � commerce domain architecture

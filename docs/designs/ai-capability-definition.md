...
## See also
- `docs/architecture/AI_01_ai_services_overview.md` � AI services overview
- `docs/architecture/AI_02_nlp_pipeline_design.md` � NLP pipeline design
- `docs/architecture/AI_03_skill_tagging_service_design.md` � skill tagging service
- `docs/designs/adaptive-learning-engine.md` � adaptive learning engine

...
| Spec ref | `docs/specs/offline-sync-spec.md`, `docs/contracts/offline-sync-interface-contract.md` |
...
| Spec ref | `docs/specs/onboarding-spec.md`, `docs/specs/notification-service-spec.md` |
...
| Spec ref | `docs/specs/interaction-layer-spec.md` (BUILT — DF-03 resolved 2026-04-11), `docs/specs/notification-service-spec.md` |
...
| Spec ref | `docs/designs/checkout-service-design.md`, `docs/contracts/payment-provider-adapter-contract.md` |
...
| Spec ref | `docs/specs/media-security-spec.md`, `docs/contracts/media-security-interface-contract.md` |
...
| Spec ref | `docs/specs/workflow-engine-spec.md`, `docs/specs/operations-os-spec.md` |

...
**Source authority:** `workspace/foundation/market-research.md` §3.2 (Coaching Academies — multi-branch complexity)
...
| `docs/specs/capability-domain-map.md` | Register `CAP-MULTI-BRANCH` |

---

## References

- `docs/specs/platform-behavioral-contract.md` — BC-BRANCH-01
- `docs/designs/entitlement-service-design.md` — entitlement model
- `docs/designs/audit-policy-layer-design.md` — audit trail for branch ops
- `docs/specs/enterprise-control-spec.md` — enterprise role management
- `docs/specs/features/org-hierarchy-spec.md` — org/branch data model
- `workspace/foundation/market-research.md` §3.2 (coaching academy multi-branch complexity)

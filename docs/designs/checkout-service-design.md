...
## See also
- `docs/designs/invoice-billing-service-design.md` � invoice and billing service
- `docs/designs/revenue-service-design.md` � revenue service design
- `docs/contracts/payment-provider-adapter-contract.md` � payment provider adapter contract

...
All LMS V2 events MUST use the shared envelope defined in `docs/anchors/event-envelope.md`. Field definitions and conformance rules are maintained there — do not duplicate them here.

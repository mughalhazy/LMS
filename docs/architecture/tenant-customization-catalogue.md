...
Tenant-level configuration keys and their scope. Each row defines a configuration area, the config key, its description, and which tenant context it applies to.

> **DEPRECATED** — Superseded by: `docs/architecture/ARCH_05_event_driven_architecture.md`
> Reason: ARCH_ doc is higher-priority and covers the same topic with full QC validation.

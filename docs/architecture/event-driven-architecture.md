...
All events MUST use the shared envelope defined in `docs/anchors/event-envelope.md`. That doc is the single authoritative schema — do not duplicate the field definitions here.

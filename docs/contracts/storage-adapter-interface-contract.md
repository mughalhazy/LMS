...
**Source:** `adapter-inventory.md` — required this doc as part of storage adapter implementation
...
- `docs/contracts/payment-provider-adapter-contract.md`
...
- `docs/designs/file-storage-design.md` — bucket/content-type design
- `docs/specs/adapter-inventory.md` — adapter registry

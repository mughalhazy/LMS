...
## See also
- `docs/specs/media-pipeline-spec.md` � media pipeline spec
- `docs/architecture/security-architecture.md` � LMS security architecture
- `docs/contracts/storage-adapter-interface-contract.md` � storage adapter interface contract

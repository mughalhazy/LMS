...
> **BOS source:** `workspace/foundation/behavioral-spec.md` §6.2
...
**Specification:**
- This adapter contract currently defines channel-agnostic transport. This behavioral rule governs the CALLER's responsibility when building messages that carry embedded actions (see BC-INT-01 in `interaction-layer-spec.md`).
...
**Contract name:** MS-ADAPTER-01 (authoritative definition in `docs/specs/adapter-inventory.md`)
...
See `docs/specs/adapter-inventory.md` MS-ADAPTER-01 for the full four-rule adapter isolation contract.

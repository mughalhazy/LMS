...
DailyAlert = _ModelsModule.DailyAlert
ActionItem = _ModelsModule.ActionItem
...
class AcademyOpsService:
    ...
    def __init__(self) -> None:
        ...
        self._absence_streaks: dict[tuple[str, date], list[dict[str, Any]]] = {}
        self._inactivity_signals: dict[tuple[str, date], list[dict[str, Any]]] = {}
        self._failed_communications: dict[tuple[str, date], list[dict[str, Any]]] = {}
    ...
    def list_absence_streaks(self, *, tenant_id: str, run_date: date) -> tuple[dict[str, Any], ...]:
        return tuple(self._absence_streaks.get((tenant_id.strip(), run_date), []))

    def list_inactivity_signals(self, *, tenant_id: str, run_date: date) -> tuple[dict[str, Any], ...]:
        return tuple(self._inactivity_signals.get((tenant_id.strip(), run_date), []))

    def list_failed_communications(self, *, tenant_id: str, run_date: date) -> tuple[dict[str, Any], ...]:

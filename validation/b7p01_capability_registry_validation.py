...
BATCH0_FILES = [
    ...
    ROOT / "docs/architecture/capabilities/B0P05_business_capabilities.json",
    ROOT / "docs/architecture/capabilities/B0P06_communication_capabilities.json",
    ROOT / "docs/architecture/capabilities/B0P07_delivery_capabilities.json",
    ROOT / "docs/architecture/capabilities/B0P08_intelligence_capabilities.json",
]

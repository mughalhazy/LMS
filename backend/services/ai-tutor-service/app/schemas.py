...
class TutorResponse(BaseModel):
    ...
    created_at: datetime
    # MS-AI-01 (MS§10.8): AI output labeling, guidance level, and human override path.
    # All AI-generated responses must carry these fields so learners and operators
    # can identify AI origin, assess confidence level, and request human review.
    ai_generated: bool = True
    # guidance_level: suggestion | advisory | informational
    #   suggestion    — recommended action, not authoritative
    #   advisory      — context-aware feedback, treat as informed advice
    #   informational — factual content delivery, lowest override urgency
    guidance_level: str = "suggestion"
    human_review_available: bool = True
    override_path: str = "support://request-human-review"

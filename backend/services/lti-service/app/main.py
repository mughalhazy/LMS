...
@app.post("/api/v1/lti/provider/tools/register")
def provider_register_tool(req: ToolRegistrationRequest):
    return service.register_provider_tool(req)


@app.post("/api/v1/lti/provider/tools/validate-activation")
...
@app.post("/api/v1/lti/consumer/launch/complete")

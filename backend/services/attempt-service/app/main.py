...
@app.post("/api/v1/attempts", response_model=AttemptResponse)
...
@app.post("/api/v1/attempts/{attempt_id}/answers", response_model=AttemptResponse)
...
@app.post("/api/v1/attempts/{attempt_id}/score", response_model=AttemptResponse)
